...
data class ModelData(
    ...
    /**
     * On-device directory containing a pre-staged bundle; required when
     * [hub] is `LOCALFS`. Used to side-load an AI Hub bundle that isn't
     * yet resolvable through the hub catalog by name.
     */
